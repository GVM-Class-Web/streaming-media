            ...
            <div>
                <header className="header">
                    ...
                    <div id="search" className="search">
                        ...
                        <input onKeyUp={this.handleKeyUp} onChange={this.handleChange} type="search" placeholder="Search your favorite video.." />
                    </div>
                    <UserProfile />
                </header>
                <Headline />
        ...
        return (
            <div className="userProfile">
                <div className="user">
                    ...
                    <div className="image"><img src="favicon.ico" alt="profile" /></div>
                </div>
            </div>
        );
    }
